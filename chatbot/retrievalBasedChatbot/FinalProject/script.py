...
class ChatBot:
  ...
  #define .chat() below:
  def chat(self):
    user_message = input("How can I help you, friend? ")
  ...
  def find_entities(self, user_message):
    tagged_user_message = extract_nouns(pos_tag(preprocess(user_message)))

    tokens = word2vec(" ".join(tagged_user_message))
  ...
  def respond(self, user_message):
    ...
    input_message = input("How else can I serve you? ")
